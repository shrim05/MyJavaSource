...
public class LoginController {
	...
	@URIMapping(value="/login", method=HttpMethod.GET)
	public String loginGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
