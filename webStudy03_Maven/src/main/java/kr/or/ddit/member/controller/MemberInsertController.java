...
public class MemberInsertController extends HttpServlet{
   ...
   public String insertGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      return "member/memberForm";
   }
   
   
   @URIMapping(value="/member/memberInsert.do",method=HttpMethod.POST)
   public String insertPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
